  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-6">
      <div className="max-w-md w-full text-center">
        ...
        <h1 className="text-4xl font-bold mb-3 text-slate-800">Klinik Asy-Syifa</h1>
        <p className="text-slate-500 mb-8 leading-relaxed">
          Layanan kesehatan terpercaya. Daftar konsultasi dengan dokter kami secara online, insyaallah mudah dan satsett.
        </p>
